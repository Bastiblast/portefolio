export default function Contact() {
  return (
    <section className="mx-auto max-w-xl px-4 py-16">
      <h1 className="font-serif text-3xl text-petrol">Contact</h1>
      <form className="mt-6 space-y-4">
        ...
        <div>
          ...
          <textarea rows={5} className="w-full rounded-md border px-3 py-2 bg-transparent border-sage" placeholder="Votre message..." />
        </div>
