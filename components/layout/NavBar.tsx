      ...
      <nav>
        ...
        <div id="social-link" className="flex items-center">
          <ButtonGroup className="md:h-12 mr-4">
            <Link href="https://github.com/Bastiblast/" aria-label="GitHub" className="p-2 no-underline text-foreground hover:text-primary transition-colors">
            ...
            <Link href="https://www.linkedin.com/in/bastien-million-608740322" aria-label="LinkedIn" className="p-2 no-underline text-foreground hover:text-secondary transition-colors">
        ...
        <div id="mobile-second-row"  className="md:hidden mx-2 mb-2 py-3">
         <Links/>
        </div>
        </div>
